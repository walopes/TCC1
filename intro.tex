...
\begin{comment}
Devido à imensa aplicabilidade e utilidade que os robôs apresentam, foram criadas competições que visam estimular e 
contribuir com a pesquisa na robótica, 
como a \citeonline{robocup}, que neste ano foi sediada em Leipzig, Alemanha, a \citeonline{robotrace}, 
realizada no Japão, 
% Robotrace: Disponível em http://www.ntf.or.jp/mouse/micromouse2014/kitei_trace_since2014-EN.html.
assim como a \citeonline{robocore}, com eventos realizados no Brasil. O WinterChallenge, realizado pela Robocore, 
é um dos maiores eventos mundiais de robótica, contando com a participação de vários países da América Latina e teve 
mais de mil competidores e cerca de quinhentos robôs em sua última edição \cite{maua}.\par
\end{comment}

\begin{comment}
Devido à imensa aplicabilidade e utilidade que os robôs apresentam, foram criadas competições que visam estimular e 
contribuir com a pesquisa na robótica, como a \citeonline{robogames}, também conhecida como ``Olimpíada dos robôs'', em 
que são disputadas mais de cinquenta categorias, a VEX \citeonline{vex}, 
a maior competição de robótica do mundo, que contou com 1075 times e mais de 15.000 participantes em sua 
última edição \cite{vex_guiness}, a \citeonline{robocup}, que neste ano foi sediada em Leipzig, Alemanha, 
assim como a \citeonline{robocore}, com eventos realizados no Brasil. O WinterChallenge, realizado 
anualmente pela Robocore, em São Paulo, 
...
e do México, na Robocore, estes obtendo os três 
primeiros lugares na competição WinterChallenge na categoria Seguidor de Linha - Pro. Na mesma modalidade, 
...
% Ver parte inteligência: Livro Princípios da mecatrônica, Rosário, Pagina 145 -> 629.8
\end{comment}
...
O trabalho de \citeonline{allan}, %o qual também contribuiu para \citeonline{alemao}, utilizou-se de controle híbrido, a qual 
...
\section{Limitações do Trabalho}\label{limitacoes}
 ...
 %apresentar restrições de desempenho e até mesmo não funcionar, caso a pista não esteja no padrão estabelecido. 

 %\item Devido à dificuldade em encontrar e adquirir peças de alto desempenho, poderão ser utilizadas peças de menor custo, as 
 %quais podem reduzir o desempenho do robô;
...
Projetar e implementar um protótipo de um robô seguidor de linha, com velocidade próxima a 2 m/s, que seja autônomo,
...
%\begin{comment}
 %\item Projetar o condicionamento de sinais para os dispositivos a serem utilizados, permitindo a exata e eficaz leitura dos 
 %sensores;
 %\end{comment}
