...
fato de qualquer Sistema a Eventos Discretos tem um conjunto implícito $E$ associado a ele. \citeonline{cassandras} chama esse 
...
pessoal, e deseja-se projetar um sistema que realize a simples tarefa: Quando a máquina estiver ligada, esta primeiramente deve 
indicar que está ligada e depois reportar este fato (como no caso de \textquotedblleft checar óleo\textquotedblright, caso seja um 
