...
veículo Sojourner, utilizado na missão, explorou o território marciano por 83 dias, tirando fotografias e realizando 
medições do ambiente \cite{nasa}. O veículo pode ser visto na Figura \ref{fig:nasa}.
...
o seu movimento, compreensão e raciocínio nesta área, sendo estes três subproblemas essenciais para este campo 
\cite{dudek_mobile}.
...
%Robôs com pernas (\textit{legged robots}) e robôs com rodas (\textit{wheeled robots}). Os robôs com rodas serão os alvos de 
%estudo deste trabalho. (pagina 
