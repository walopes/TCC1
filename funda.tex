...
\begin{figure}[h!]
 \centering
 \captionsetup{width=0.54\textwidth,font=footnotesize,textfont=bf}
 %\includegraphics[scale=0.6]{figuras/nasa.png}
...
\begin{figure}[h!]
 \centering
 \captionsetup{width=0.75\textwidth,font=footnotesize,textfont=bf}
 %\includegraphics[scale=0.6]{figuras/nasa.png}
...
posição do robô.
  \begin{itemize}
   ...
   mostra um circuito integrado (\sigla{CI}{Circuito Integrado}) de um acelerômetro.
  \end{itemize}
