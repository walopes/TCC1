...
%\citeonline{heinen} propôs um sistema de controle robusto capaz de se adaptar e operar em diferentes ambientes e condições.
%\citeonline{heinen} também propôs uma arquitetura de controle híbrida (COHBRA), integrando as técnicas de controle deliberativo e 
...
% Agora falar do Pessim
%Em \citeonline{pessin} foi feita uma busca por uma técnica
...
\begin{figure}
    ...
    \begin{subfigure}[b]{0.4\textwidth}
        \includegraphics[width=\textwidth,height=0.25\textheight]{figuras/marcio1.png}
        \caption{\centering \label{fig:marcio}}
    \end{subfigure}
    ~ %add desired spacing between images, e. g. ~, \quad, \qquad, \hfill etc. 
      %(or a blank line to force the subfigure onto a new line)
    \begin{subfigure}[b]{0.4\textwidth}
        \includegraphics[width=\textwidth,height=0.25\textheight]{figuras/polulumod.png}
    ...
    %(or a blank line to force the subfigure onto a new line)
    \begin{subfigure}[b]{0.4\textwidth}
        \includegraphics[width=\textwidth,height=0.25\textheight]{figuras/allan.png}
    ...
    ~ %add desired spacing between images, e. g. ~, \quad, \qquad, \hfill etc. 
      %(or a blank line to force the subfigure onto a new line)
    \begin{subfigure}[b]{0.4\textwidth}
        \includegraphics[width=\textwidth,height=0.25\textheight]{figuras/Hirai.png}
...
\begin{figure}
 \centering
 \begin{tabular}[b]{c}
  \includegraphics[width=0.3\linewidth]{{figuras/marcio1.png}
  \small (a)
 \end{tabular} \qquad
 \begin{tabular}[b][c]
  \includegraphics[width=0.3\linewidth]{{figuras/polulumod.png}
  \small (b)
 \end{tabular}
...
%% Colocar somente os robôs do marcio em subfloat
\begin{figure*}[h!]
    \centering
    %\raggedright
    \captionsetup{width=0.74\textwidth,font=footnotesize,textfont=bf}
    \begin{subfigure}[t]{0.4\textwidth}
        \centering
        %%\raggedleft
        \includegraphics[scale=0.5]{figuras/marcio1.png}
        %\caption{Protótipo final \label{fig:marcio}}
        \caption{ \label{fig:marcio}}
        %\caption*{Fonte: \cite[p.56]{alemao}}
    \end{subfigure}%
    %~\hspace{1cm} 
    ~\hspace{0.4cm}
    \begin{subfigure}[t]{0.3\textwidth}
        \centering
        %\raggedleft
        \includegraphics[scale=0.53]{figuras/polulumod.png}
        %\caption{Robô 3pi \label{fig:pololu}}
        \caption{ \label{fig:pololu}}
        %\caption*{Fonte: \cite[p.58]{alemao}}
    \end{subfigure}
    \caption{Robôs utilizados por \cite{alemao}. \ref{fig:marcio} é o robô \textit{Alpha Project} e \ref{fig:pololu} é o 
    Pololu 3pi modificado.}
\end{figure*}

%% Colocar o robô do Hirai

Na revisão bibliográfica a seguir são mostradas as técnicas 
\end{comment}
...
as mais diversas situações. Para tanto se utiliza de um sistema de controle, que para \citeonline{nise} consiste em subsistemas e 
processos, conhecidos como plantas, dos quais se obtém uma saída com desempenho desejado para uma dada entrada.

No caso do robô, mui

\begin{comment}
Para \citeonline{nise}, um Sistema de Controle consiste em subsistemas e processos, conhecidos como plantas, dos quais se obtém uma 
saída com desempenho desejado para uma dada entrada.
%Desta forma, utiliza-se de um sistema de controle para que o robô seja autônomo, um dos requisitos dos robõs móveis.
%Este subsistema é chamado de planta
Para que seja possível de controlar um sistema, é necessário saber o que se deseja controlar
\end{comment}
